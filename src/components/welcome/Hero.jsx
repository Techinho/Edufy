  ...
  return (
    <section className="relative text-white min-h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 sm:px-8 max-w-4xl" data-aos="fade-up">
        ...
        <p className="text-xl sm:text-2xl text-blue-400 font-bold mb-6 sm:mb-8" data-aos="fade-up" data-aos-delay="600">
          All Courses Now 100% Free!
        </p>
        <div className="flex flex-col sm:flex-row justify-center gap-3 sm:gap-4">
          <Link
            to={"/signup"}
            className="px-5 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-md transition duration-300 ease-in-out transform hover:scale-105"
            data-aos="fade-right"
            data-aos-delay="800"
          >
            Start Learning Now
          ...
          <Link 
            to={"/courses"}
            className="px-5 py-3 bg-white hover:bg-gray-100 text-blue-600 font-semibold rounded-lg shadow-md transition duration-300 ease-in-out transform hover:scale-105"
            data-aos="fade-left"
            data-aos-delay="800"
          >
